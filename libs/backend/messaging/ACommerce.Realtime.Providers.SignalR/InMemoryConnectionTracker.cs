...
/// <summary>
/// تتبع الاتصالات في الذاكرة.
/// مناسب للنشر أحادي المثيل (single instance).
/// للنشر الموزع استخدم RedisConnectionTracker.
/// </summary>
public class InMemoryConnectionTracker : IConnectionTracker
{
    ...
    /// <summary>عدد المستخدمين المتصلين حالياً</summary>
