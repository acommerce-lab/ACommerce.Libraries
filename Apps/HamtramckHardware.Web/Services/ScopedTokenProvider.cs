...
/// <summary>
/// Wrapper for TokenManager that can be used as a singleton.
/// Uses IServiceScopeFactory to access the scoped TokenManager
/// with static cache to avoid reinitialization on each request.
/// </summary>
