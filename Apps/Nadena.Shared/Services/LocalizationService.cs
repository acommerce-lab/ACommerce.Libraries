...
public class LocalizationService : BaseLocalizationService
{
    ...
    private static void AddArabicTranslations(Dictionary<string, string> ar)
    {
        // App (Required)
        ar["AppName"] = "نادينا";
        ar["AppTagline"] = "أندية الحي.. شغفٌ ومهارات";

        // Bookings (Ashare-specific)
        ar["Bookings"] = "تسجيلاتي";
        ar["MyBookings"] = "تسجيلاتي";
        ar["Upcoming"] = "القادمة";
        ar["Past"] = "السابقة";
        ...
        ar["Spaces"] = "الأندية";
        ar["AllSpaces"] = "كل الأندية";
        ar["FeaturedSpaces"] = "الأندية المميزة";
        ar["NewSpaces"] = "أحدث الأندية";
        ar["NearbySpaces"] = "القريبة منك";
        ar["NoSpaces"] = "لا توجد أندية";
        ...
        // Booking
        ar["BookNow"] = "سجّل الآن";
        ar["BookSpace"] = "سجّل في النادي";
        ...
        // Search
        ar["SearchSpaces"] = "ابحث عن نادٍ أو نشاط...";
        ...
        ar["WelcomeToAshare"] = "مرحباً بك في نادينا";
        ...
        ar["Host"] = "المضيف";
        ar["MySpaces"] = "أنديتي";
        ar["AddNewSpace"] = "أضف نادياً جديداً";
        ar["Earnings"] = "أرباحي";
        ar["MyEarnings"] = "أرباحي";
        ar["NoSpacesYet"] = "لا توجد أندية بعد";
        ...
        ar["Status"] = "الحالة";
        ar["SpaceOwner"] = "مشرف النادي";
        ar["YourListing"] = "معلنك";
        ar["ViewAll"] = "عرض الكل";
        ar["NotSpecified"] = "غير محدد";
        ar["ExploreSpaces"] = "استكشف الأنشطة";
    ...
    private static void AddEnglishTranslations(Dictionary<string, string> en)
    {
        // App (Required)
        en["AppName"] = "Nadena";
        en["AppTagline"] = "Neighborhood Clubs, Passion and Skills";
        ...
        en["WelcomeToAshare"] = "Welcome to Nadena";
    ...
    private static void AddUrduTranslations(Dictionary<string, string> ur)
    {
        // App (Required)
        ur["AppName"] = "نادینا";
        ur["AppTagline"] = "محلے کے کلب.. شوق اور مہارت";
