...
namespace Nadena.Shared.Extensions;

public static class ServiceCollectionExtensions
{
    public static IServiceCollection AddNadenaClients(
    ...
    public static IServiceCollection AddNadenaServices(this IServiceCollection services)
    {
        services.AddScoped<ILocalizationService, LocalizationService>();
        services.AddScoped<NadenaApiService>();
