...
public static class AnalyticsSettings
{
    ...
    // ═══════════════════════════════════════════════════════════════════
    // وضع الاختبار (Mock Mode)
    // ═══════════════════════════════════════════════════════════════════

    /// <summary>
    /// تفعيل Mock Provider للاختبار المحلي بدون الحاجة لـ IDs فعلية
    /// يطبع كل الأحداث في Console/Output بدلاً من إرسالها للمنصات
    /// 
    /// الاستخدام:
    /// 1. اضبط UseMockProvider = true
    /// 2. شغّل التطبيق على المحاكي أو الجهاز
    /// 3. راقب Output/Logcat لرؤية الأحداث
    /// 
    /// ستظهر الأحداث بالشكل التالي:
    /// [MockAnalytics] 📊 Event: ViewContent | {"ContentId":"xxx","ContentName":"مساحة عمل"}
    /// [MockAnalytics] 💰 Purchase | {"TransactionId":"xxx","Value":100,"Currency":"SAR"}
    /// </summary>
    public const bool UseMockProvider = true; // غيّرها لـ false للاتصال بالمنصات الفعلية
}
