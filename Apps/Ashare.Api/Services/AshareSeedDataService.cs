...
public class AshareSeedDataService
{
        ...
        {
                var repo = _repositoryFactory.CreateRepository<LegalPage>();
                ...
                var legalPages = new List<LegalPage>
                {
                        new()
                        {
                                Id = Guid.Parse("50000000-0000-0000-0001-000000000001"),
                                Key = "privacy-policy",
                                TitleAr = "سياسة الخصوصية",
                                TitleEn = "Privacy Policy",
                                Url = "https://ashare.app/privacy",
                                Icon = "bi-shield-lock",
                                SortOrder = 1,
                                IsActive = true,
                        ...
                        new()
                        {
                                Id = Guid.Parse("50000000-0000-0000-0001-000000000002"),
                                Key = "terms-of-service",
                                TitleAr = "شروط الاستخدام",
                                TitleEn = "Terms of Service",
                                Url = "https://ashare.app/terms",
                        ...
                        new()
                        {
                                Id = Guid.Parse("50000000-0000-0000-0001-000000000003"),
                                Key = "intellectual-property",
                                TitleAr = "الملكية الفكرية",
                                TitleEn = "Intellectual Property",
                                Url = "https://ashare.app/intellectual-property",
                        ...
                        new()
                        {
                                Id = Guid.Parse("50000000-0000-0000-0001-000000000004"),
                                Key = "complaints-suggestions",
                                TitleAr = "سياسة الشكاوى والاقتراحات",
                                TitleEn = "Complaints & Suggestions Policy",
                                Url = "https://ashare.app/complaints",
                        ...
                        new()
                        {
                                Id = Guid.Parse("50000000-0000-0000-0001-000000000005"),
                                Key = "contact-us",
                                TitleAr = "تواصل معنا",
                                TitleEn = "Contact Us",
                                Url = "https://ashare.app/contact",
                                Icon = "bi-envelope",
                                SortOrder = 5,
                                IsActive = true,
                                CreatedAt = DateTime.UtcNow
                ...
                foreach (var page in legalPages)
                {
                        if (!existingKeys.Contains(page.Key))
                        {
                                ...
                                Console.WriteLine($"[Seed] Added legal page: {page.TitleAr} ({page.Key})");
                        }
                }

                Console.WriteLine($"[Seed] Legal pages seeding complete. Total: {legalPages.Count}");
        }
