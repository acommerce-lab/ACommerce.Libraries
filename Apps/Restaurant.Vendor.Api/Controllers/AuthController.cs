...
public class AuthController : ControllerBase
{
    ...
    /// <summary>
    /// طلب إرسال رمز OTP للهاتف (صاحب المطعم)
    /// </summary>
    [HttpPost("otp/send")]
    public async Task<ActionResult<SendOtpResponse>> SendOtp([FromBody] VendorLoginRequest request)
    {
        ...
        var result = await _authService.SendOtpAsync(request.PhoneNumber, "Vendor");
        return Ok(result);
    }
