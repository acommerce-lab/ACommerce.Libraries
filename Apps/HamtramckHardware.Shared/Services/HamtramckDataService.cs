...
public class HamtramckDataService
{
    ...
    public List<HomeProductItem> GetAllProducts() => new()
    {
        ...
        new() { Id = Guid.Parse("a0000009-0000-0000-0000-000000000009"), Name = "Husky 52\" 15-Drawer Mobile Workbench", Image = "https://images.unsplash.com/photo-1586864387967-d02ef85d93e8?w=400&h=400&fit=crop", Price = 599.99m, OldPrice = 899.99m, Rating = 4.6, ReviewCount = 423, Attributes = new() { { "Brand", "Husky" }, { "Category", "hand-tools" } } },
        new() { Id = Guid.Parse("a0000010-0000-0000-0000-000000000010"), Name = "Copper Pipe Fittings Set 1/2\" - 25 Pieces", Image = "https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=400&h=400&fit=crop", Price = 24.99m, OldPrice = 29.99m, Rating = 4.2, ReviewCount = 312, Attributes = new() { { "Brand", "Stanley" }, { "Category", "plumbing" } } },
        new() { Id = Guid.Parse("a0000011-0000-0000-0000-000000000011"), Name = "SharkBite 1/2\" Push-to-Connect Coupling", Image = "https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=400&h=400&fit=crop", Price = 12.99m, Rating = 4.6, ReviewCount = 892, Attributes = new() { { "Brand", "SharkBite" }, { "Category", "plumbing" } } },
        new() { Id = Guid.Parse("a0000012-0000-0000-0000-000000000012"), Name = "Stanley FatMax Copper Pipe Cutter", Image = "https://images.unsplash.com/photo-1581147036324-c17ac41f3f2c?w=400&h=400&fit=crop", Price = 34.99m, Rating = 4.5, ReviewCount = 312, Attributes = new() { { "Brand", "Stanley" }, { "Category", "plumbing" } } },
        new() { Id = Guid.Parse("a0000013-0000-0000-0000-000000000013"), Name = "PVC Pipe 10ft Schedule 40 - 3/4\" Bundle of 5", Image = "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=400&h=400&fit=crop", Price = 18.99m, Rating = 4.0, ReviewCount = 234, Attributes = new() { { "Brand", "Charlotte Pipe" }, { "Category", "plumbing" } } },
        new() { Id = Guid.Parse("a0000014-0000-0000-0000-000000000014"), Name = "Southwire Romex 12/2 NM-B Wire 250ft", Image = "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=400&h=400&fit=crop", Price = 89.99m, OldPrice = 99.99m, Rating = 4.8, ReviewCount = 567, Attributes = new() { { "Brand", "Southwire" }, { "Category", "electrical" } } },
        new() { Id = Guid.Parse("a0000015-0000-0000-0000-000000000015"), Name = "LED Shop Light 4ft Linkable - 2 Pack", Image = "https://images.unsplash.com/photo-1565814329452-e1efa11c5b89?w=400&h=400&fit=crop", Price = 39.99m, Rating = 4.5, ReviewCount = 456, Attributes = new() { { "Brand", "Lithonia" }, { "Category", "electrical" } } },
        new() { Id = Guid.Parse("a0000016-0000-0000-0000-000000000016"), Name = "Leviton 15A Tamper-Resistant Outlet (10-Pack)", Image = "https://images.unsplash.com/photo-1558402529-d2638a7023e9?w=400&h=400&fit=crop", Price = 24.99m, Rating = 4.7, ReviewCount = 1567, Attributes = new() { { "Brand", "Leviton" }, { "Category", "electrical" } } },
        new() { Id = Guid.Parse("a0000017-0000-0000-0000-000000000017"), Name = "Flexzilla Garden Hose 5/8\" x 50ft", Image = "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=400&h=400&fit=crop", Price = 29.99m, Rating = 4.4, ReviewCount = 1234, Attributes = new() { { "Brand", "Flexzilla" }, { "Category", "lawn-garden" } } },
        new() { Id = Guid.Parse("a0000018-0000-0000-0000-000000000018"), Name = "Ryobi ONE+ 18V Cordless Jet Fan Blower", Image = "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop", Price = 89.99m, OldPrice = 109.99m, Rating = 4.1, ReviewCount = 543, Attributes = new() { { "Brand", "Ryobi" }, { "Category", "lawn-garden" } } },
        ...
        new() { Id = Guid.Parse("a0000022-0000-0000-0000-000000000022"), Name = "RIDGID 12-Gallon NXT Wet/Dry Shop Vacuum", Image = "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop", Price = 79.99m, OldPrice = 119.99m, Rating = 4.5, ReviewCount = 678, Attributes = new() { { "Brand", "RIDGID" }, { "Category", "power-tools" } } },
        new() { Id = Guid.Parse("a0000023-0000-0000-0000-000000000023"), Name = "Bosch 2.25 HP Combination Plunge & Fixed Base Router", Image = "https://images.unsplash.com/photo-1590122959498-1ccae0d48bc8?w=400&h=400&fit=crop", Price = 199.99m, Rating = 4.8, ReviewCount = 834, Attributes = new() { { "Brand", "Bosch" }, { "Category", "power-tools" } } },
        new() { Id = Guid.Parse("a0000024-0000-0000-0000-000000000024"), Name = "DeWalt 20V MAX XR 5.0Ah Battery 2-Pack", Image = "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400&h=400&fit=crop", Price = 99.99m, Rating = 4.9, ReviewCount = 2567, Attributes = new() { { "Brand", "DeWalt" }, { "Category", "power-tools" } } },
        new() { Id = Guid.Parse("a0000025-0000-0000-0000-000000000025"), Name = "DeWalt Titanium Drill Bit Set 29-Piece", Image = "https://images.unsplash.com/photo-1580901368919-7738efb0f87e?w=400&h=400&fit=crop", Price = 34.99m, Rating = 4.7, ReviewCount = 1834, Attributes = new() { { "Brand", "DeWalt" }, { "Category", "hand-tools" } } },
    };
